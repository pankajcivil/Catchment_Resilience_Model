/*
    ...
    calling syntax:
        result = BVP_BPC_jac(lds.func,x,p,T,pars,nc,lds,gds.period,p2)
*/
...
void mexFunction (int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
	...
	/* TJP: Add *meshtimeJac to replace *zero */
    double *meshtimeJac;
	...
	*jc = 0;
	...
	jacrhs[1] = mxCreateDoubleMatrix(nphase,1,mxREAL);
	xtmp = mxGetPr(jacrhs[1]); 
